...
public class ConexionActivity extends AppCompatActivity implements View.OnClickListener, Estado3.OnFragmentInteractionListener {
    public static final String estado = "Conectado";
    public ProgressBar BarraEspera;
    public TextView MAC;
    public Button Estado3;
        ...
        btmView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getItemId() == R.id.btn_hora){
                    fragmentoSeleccionado(new Estado3(), "Establecer Hora - Conectado");
                }
